...
func (a *AndroidApp) installPath(ctx android.ModuleContext) android.InstallPath {
	...
	} else if ctx.ModuleName() == "com.afterlifeos.platform-res" {
		// com.afterlifeos.platform-res.apk is installed as system/framework/com.afterlifeos.platform-res.apk
		installDir = "framework"
...
func (a *AndroidApp) dexBuildActions(ctx android.ModuleContext) (android.Path, android.Path) {
	...
	if ctx.ModuleName() != "framework-res" && ctx.ModuleName() != "com.afterlifeos.platform-res" {
...
>>>>>>> 2426c578fa97e9544e505895ad0de61e6f6215be
	}
